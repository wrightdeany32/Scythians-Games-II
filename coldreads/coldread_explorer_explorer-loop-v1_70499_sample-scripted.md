...
Options:
1. You came back to start something.
2. You came back because it was the one door still open.

**Reader:** [reader think-aloud for ux_explorer_opening]
**Picked:** 1. You came back to start something.
...
**Picked:** 1. "Probably a bat. They get down this deep."
...
**Picked:** 1. "You're right. Teenagers. Little idiots with too much rope."
...
**Picked:** 1. Shed the pack — push it ahead, take the loss.
...
## Step 1 — `ux_return_enter`

Neither of you has said out loud that you can't stop thinking about it.

You call Reese. He says no, and then he says when, which is how Reese says yes.
...
Options:
1. "Let's just get it done."
2. "…I don't know why I wanted to come back."
3. "It's a hole in the ground. That's all it is."

**Reader:** [reader think-aloud for ux_return_enter]
**Picked:** 1. "Let's just get it done."

> trace: day 2 · stats — · flags return_committed=true

## Step 2 — `ux_return_descend`
...
Options:
1. "Keep going."
2. "Slow down. Look at everything."

**Reader:** [reader think-aloud for ux_return_descend]
**Picked:** 1. "Keep going."

> trace: day 2 · stats — · flags —

## Step 3 — `ux_return_erased`
...
Options:
1. "We should go."
2. "There's more of it deeper. I want to see."

**Reader:** [reader think-aloud for ux_return_erased]
**Picked:** 1. "We should go."

> trace: day 2 · stats — · flags —

## Step 4 — `ux_return_fork`
...
**Reader:** [reader think-aloud for ux_return_fork]
**Picked:** 1. "Go down."

> trace: day 2 · stats — · flags return_went_deep=true

## Step 5 — `ux_return_deep`
...
**Reader:** [reader think-aloud for ux_return_deep]
**Picked:** 1. Go to it.

> trace: day 2 · stats — · flags —

## Step 6 — `ux_return_knife_deep`
...
Options:
1. "I haven't thought about this knife in years."
2. Say nothing. You don't have words.
3. "You're right. It fell out of my pack."
4. "We weren't in this part of the cave, Reese. Neither of us has ever been down here."

**Reader:** [reader think-aloud for ux_return_knife_deep]
**Picked:** 1. "I haven't thought about this knife in years."

> trace: day 2 · stats — · flags —

## Step 7 — `ux_return_end`
...
**Reader:** [reader think-aloud for ux_return_end]
**Picked:** 1. Carry it out.
...
_Operator notes: scripted loop sample — not a real reader_
