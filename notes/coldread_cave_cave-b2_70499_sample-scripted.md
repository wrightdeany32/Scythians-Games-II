...
3. Take one thing off the wall first.

**Reader:** [reader think-aloud for ux_cave_return]
**Picked:** 3. Take one thing off the wall first.

> trace: day 1 · stats grip -1 · flags took_shard=true, cave_done=true, cave_deep_seen=true · roll squeeze d20 5+0=5 vs 10 → LOSE

## — end of scene —

You chip a piece of the marked stone free and pocket it.

You get out — pack torn away on the rock — but the shard stays on you.
