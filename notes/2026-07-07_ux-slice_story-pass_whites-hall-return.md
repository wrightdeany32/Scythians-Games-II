...
You don't understand anything else about it. You just know, now, that it was always saying which way.
...
Not with an answer — with a knife you can hold, in a place it cannot be, and a friend beside you insisting on the one story that lets him keep driving. Whatever it was, it reached across your whole life to put a dead man's knife in your hand, and you are still standing in its dark, and it knows the reaching didn't turn you away.

> DESIGN: The flagship's terminal — an authored terminal flag, `run_end_whites_return`, not a lost-grip death; the loop's scene-exit rules hand the run to its ending. The four threads (Doug, Marie, Nora, Reese) are left live and unresolved — this is a *closer*, not a resolution. The buried weight, sealed: a terrified power spent the most it could still afford to warn you off, and you came anyway, and now it knows its one lever failed. The player is told none of that. They get the vertigo of the knife and the silence after, and they carry the question out into their own afternoon.
